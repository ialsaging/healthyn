---
title: 'Predicted Values: Alcohol consumption status predicted by age x neuroticism x conscientiousness'
output: 
  html_document:
    toc: TRUE
    toc_depth: 2
...
```{r load_data, echo = F}
load(here("created data/plot_drinker_age.Rdata"))
```
...
First we load the meta-analysis objects. To see how these objects were created, see the meta-analysis scripts titled XXXXX that are available at [osf.io/XXXX](https://osf.io/XXXX/).
