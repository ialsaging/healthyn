...
```{r load_data, echo = F}
load(here("created data/plot_smoker.Rdata"))
```
...
The files needed for this table are available at [osf.io/mzfu9](https://osf.io/mzfu9/) in the Meta Analysis Output folder.To see how these objects were created, see the meta-analysis scripts titled XXXXX that are available at [osf.io/XXXX](https://osf.io/XXXX/).
