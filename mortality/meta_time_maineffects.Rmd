---
title: "Supplementary File: Meta analysis of main effects (time since baseline as metric)"
...
```{r}
save(meta.results.time.neur, meta.results.time.con, file = "../created data/main_effects_rma.Rdata")
```
...
```{r, echo = FALSE}
save(meta.results.time.neur, file = "../created data/main_effects_neur.Rdata")
save(meta.results.time.con,  file = "../created data/main_effects_con.Rdata")
```
