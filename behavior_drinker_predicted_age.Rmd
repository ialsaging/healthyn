...
First we load the meta-analysis objects. To see how these objects were created, see the meta-analysis script titled `drinker_meta-analysis.R` that are available at [osf.io/kb9e8](https://osf.io/kb9e8/).
