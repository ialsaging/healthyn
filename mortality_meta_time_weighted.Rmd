---
title: "Meta analysis of interaction (weighted by number who died)"
output: 
  html_document:
    toc: TRUE
    toc_depth: 2
    ...
    theme: cosmo 
---
This document contains the meta-analysis of the surivival models, using time since baseline as the metric of interest and neuroticism by conscientiousness as the predictor of interest. Here, we weight the datasets in the meta analysis by number of participants who died during the study period. 
