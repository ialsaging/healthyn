...
load(here("created data/ELSA_cc_output_nosrh.Rdata"))
load(here("created data/HRS_cc_output_nosrh.Rdata"))
...
load(here("created data/nas_cc_output_nosrh.Rdata"))
load(here("created data/OATS_cc_output_nosrh.Rdata"))
load(here("created data/ROS_cc_output.Rdata"))
load(here("created data/SLS_cc_output_nosrh.Rdata"))
load(here("created data/WLS_cc_output_nosrh.Rdata"))
load(here("created data/LBLS_cc_output_nosrh.Rdata"))
...
```{r, echo = FALSE}
save(describe.df, file = here("output/describe.Rdata"))
```
